...
11. Implement react-beforeunload to prevent the browser from refreshing. 12Instead of using localstorage to generate an incremented index, IIFE(immediately invoked function expressions) will be a better choice to populate the unique index
